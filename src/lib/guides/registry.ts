...
export const GUIDES: GuideMeta[] = [
  ...
  },
  {
    categoryKey: 'insurance',
    topicKey: 'insurance',
    slug: 'top-healthcare-claim-denial-codes-explained',
    title: 'Top Healthcare Claim Denial Codes Explained',
    description: 'A high-signal breakdown of the most common healthcare claim denial/adjustment codes and the fastest safe fix path.',
    lastUpdated: '2026-04-16',
  },
  {
    categoryKey: 'insurance',
    topicKey: 'insurance',
    slug: 'prior-authorization-and-eligibility-errors-in-healthcare-claims',
    title: 'Prior Authorization and Eligibility Errors in Healthcare Claims',
    description: 'Practical guidance for authorization and eligibility failures: what to verify, what to correct, and what to document.',
    lastUpdated: '2026-04-16',
  },
  {
    categoryKey: 'insurance',
    topicKey: 'insurance',
    slug: 'auto-insurance-claim-denial-reasons-coverage-liability-and-fraud',
    title: 'Auto Insurance Claim Denial Reasons: Coverage, Liability & Fraud',
    description: 'A field-tested guide to the most common auto claim denial patterns and how to resolve disputes without repeat denials.',
    lastUpdated: '2026-04-16',
  },
  {
    categoryKey: 'insurance',
    topicKey: 'insurance',
    slug: 'property-insurance-claim-denial-reasons-and-how-to-appeal',
    title: 'Property Insurance Claim Denial Reasons and How to Appeal',
    description: 'A practical playbook for property claim denials: inspection, valuation, exclusions, and documentation that wins appeals.',
    lastUpdated: '2026-04-16',
  },
  {
    categoryKey: 'insurance',
    topicKey: 'insurance',
    slug: 'renters-insurance-claim-denials-top-reasons-and-fixes',
    title: 'Renters Insurance Claim Denials: Top Reasons & Fixes',
    description: 'The top renters claim denial reasons, how to rebuild proof packages, and how to resubmit without creating duplicates.',
    lastUpdated: '2026-04-16',
  },
  {
    categoryKey: 'insurance',
    topicKey: 'insurance',
    slug: 'life-insurance-claim-delay-and-denial-guide',
    title: 'Life Insurance Claim Delay and Denial Guide',
    description: 'A step-by-step guide to life claim delays and denials: documentation, beneficiaries, exclusions, and escalation steps.',
    lastUpdated: '2026-04-16',
  },
  {
    categoryKey: 'insurance',
    topicKey: 'insurance',
    slug: 'medicare-claim-denials-carc-rarc-codes-and-fixes',
    title: 'Medicare Claim Denials: CARC/RARC Codes and Fixes',
    description: 'A Medicare-focused guide to denial/remark code patterns and a safe, payer-aware correction workflow.',
    lastUpdated: '2026-04-16',
  },
  {
    categoryKey: 'insurance',
    topicKey: 'insurance',
    slug: 'medicaid-eligibility-and-billing-errors-guide',
    title: 'Medicaid Eligibility and Billing Errors Guide',
    description: 'How to troubleshoot Medicaid eligibility and billing failures, fix common data mismatches, and avoid repeated rejections.',
    lastUpdated: '2026-04-16',
  },
  {
